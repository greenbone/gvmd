...
void
report_export_files_cleanup (report_export_files_t *);

void
report_export_remove_final_file (const report_export_files_t *);

int
init_report_export_files (report_export_files_t *);

int
init_report_export_user_context (report_export_user_context_t *,
                                 user_t);
...
int
format_report_export (const report_export_data_t,
                      report_export_files_t *);

int
store_report_export_file (const report_export_data_t,
                          report_export_files_t *);
