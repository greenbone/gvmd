          ...
          switch (delete_note (delete_note_data->note_id,
                               delete_note_data->ultimate))
            {
              case 0:
                ...
                log_event ("note", "Note", delete_note_data->note_id,
                           "deleted");
                break;
              case 2:
                ...
                log_event_fail ("note", "Note", delete_note_data->note_id,
                                "deleted");
                break;
              default:
          ...
          switch (delete_override (delete_override_data->override_id,
                               delete_override_data->ultimate))
            {
              case 0:
                ...
                log_event ("override", "Override",
                           delete_override_data->override_id, "deleted");
                break;
              case 2:
                if (send_find_error_to_client
                     ("delete_override",
                                     ...
                                     delete_schedule_data->ultimate))
              {
                case 0:
                  ...
                  log_event ("schedule", "Schedule",
                             delete_schedule_data->schedule_id, "deleted");
                  break;
                case 1:
                  SEND_TO_CLIENT_OR_FAIL
                                   ...
                                   delete_config_data->ultimate))
              {
                case 0:
                  ...
                  log_event ("config", "Scan Config",
                             delete_config_data->config_id, "deleted");
                  break;
                case 1:
                                      ...
                                      delete_alert_data->ultimate))
              {
                case 0:
                  ...
                  log_event ("alert", "Alert",
                             delete_alert_data->alert_id, "deleted");
                  break;
                case 1:
                  SEND_TO_CLIENT_OR_FAIL
                   (XML_ERROR_SYNTAX ("delete_alert",
                                      "Alert is in use"));
                  log_event_fail ("alert", "Alert",
                                  delete_alert_data->alert_id, "deleted");
                  break;
                case 2:
                  if (send_find_error_to_client
          ...
          switch (delete_filter (delete_filter_data->filter_id,
                                 delete_filter_data->ultimate))
            {
              case 0:
                ...
                log_event ("filter", "Filter",
                           delete_filter_data->filter_id, "deleted");
                break;
              case 1:
                                    ...
                                    delete_port_list_data->ultimate))
            {
              case 0:
                ...
                log_event ("port_list", "Port List",
                           delete_port_list_data->port_list_id, "deleted");
                break;
              case 1:
          ...
          switch (delete_port_range (delete_port_range_data->port_range_id))
            {
              case 0:
                ...
                log_event ("port_range", "Port Range",
                           delete_port_range_data->port_range_id, "deleted");
                break;
              case 1:
                ...
                log_event_fail ("port_range", "Port Range",
                                delete_port_range_data->port_range_id,
                                "deleted");
                break;
              case 2:
            ...
            switch (delete_slave (delete_slave_data->slave_id,
                                  delete_slave_data->ultimate))
              {
                case 0:
                  ...
                  log_event ("slave", "Slave",
                             delete_slave_data->slave_id, "deleted");
                  break;
                case 1:
          ...
          switch (delete_target (delete_target_data->target_id,
                                 delete_target_data->ultimate))
            {
              case 0:
                ...
                log_event ("target", "Target",
                           delete_target_data->target_id, "deleted");
                break;
              case 1:
            ...
            switch (request_delete_task_uuid (delete_task_data->task_id,
                                              delete_task_data->ultimate))
              {
                case 0:    /* Deleted. */
                  ...
                  log_event ("task", "Task",
                             delete_task_data->task_id, "deleted");
                  break;
                  ...
                  default:
                    {
                      ...
                      SENDF_TO_CLIENT_OR_FAIL
                       (XML_OK_CREATED_ID ("create_report_format"),
                        uuid);
                      log_event ("report_format", "Report Format", uuid,
                                 "created");
                      free (uuid);
                      break;
                    }
          ...
          if (modify_note_data->note_id == NULL)
                                    ...
                                    result))
            {
              case 0:
                ...
                log_event ("note", "Note", modify_note_data->note_id,
                           "modified");
                break;
              case -1:
                SEND_TO_CLIENT_OR_FAIL
          ...
          if (openvas_is_user_observer (current_credentials.username))
                         ...
                         modify_slave_data->password))
            {
              ...
              case 1:
                ...
                log_event_fail ("slave", "Slave", modify_slave_data->slave_id,
                                "modified");
                break;
              case 2:
                SEND_TO_CLIENT_OR_FAIL
