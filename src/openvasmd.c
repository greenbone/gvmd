  ...
  static GOptionEntry option_entries[]
    = {
        ...
        { "scanner-ca-pub", '\0', 0, G_OPTION_ARG_STRING, &scanner_ca_pub,
          "Scanner CA public key path for --[create|modify]-scanner.", "<scanner-ca-pub>" },
        { "scanner-key-pub", '\0', 0, G_OPTION_ARG_STRING, &scanner_key_pub,
          "Scanner public key path for --[create|modify]-scanner.", "<scanner-key-public>" },
        ...
        { "optimize", '\0', 0, G_OPTION_ARG_STRING, &optimize, "Run an optimization: vacuum, analyze, cleanup-config-prefs, remove-open-port-results or cleanup-port-names.", "<name>" },
