...
Ensure (manage_sql, ensure_term_has_qod_and_overrides_adds_defaults)
{
  ...
  term = ensure_term_has_qod_and_overrides (g_strdup ("min_qod=70 apply_overrides=0"));
...
main (int argc, char **argv)
{
  ...
  add_test_with_context (suite, manage_sql, ensure_term_has_qod_and_overrides_adds_defaults);
  add_test_with_context (suite, manage_sql, print_report_clean_filter_handles_null_term);
