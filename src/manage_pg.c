 ...
 /* Functions in SQL. */
  ...
  if (sql_int ("SELECT EXISTS (SELECT * FROM information_schema.tables"
               ...
               sql_database ()))
    {
     ...
     /* target_type was added in version 282 */
     if (current_db_version >= 282)
       {
...
create_tables ()
{
  ...
  sql ("CREATE TABLE IF NOT EXISTS report_exports"
     ...
     "  worker_pid integer,"
     "  notes_details integer NOT NULL DEFAULT 0,"
     "  overrides_details integer NOT NULL DEFAULT 0,"
     "  result_tags integer NOT NULL DEFAULT 0,"
     "  file_path text,"
     "  file_size bigint,"
     "  content_type text,"
     "  extension text,"
