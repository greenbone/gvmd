...
- The internal list of current Local Security Checks for the 'Auto-FP' and 'Closed CVEs' features was updated [#1381](https://github.com/greenbone/gvmd/pull/1381)
